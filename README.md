...
| Platform | Installer |
|----------|-----------|
| **Windows** | [CapForge-Setup-1.9.0.exe](https://github.com/FRSname/CapForge/releases/download/v1.9.0/CapForge-Setup-1.9.0.exe) |
| **macOS** | [CapForge-1.9.0.dmg](https://github.com/FRSname/CapForge/releases/download/v1.9.0/CapForge-1.9.0.dmg) |
