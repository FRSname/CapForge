      ...
      <div className="app-no-drag flex items-center gap-1">
        ...
        {showResults && (
          <>
            ...
            <button className="titlebar-btn" title="Save Project (Ctrl+S)" onClick={onSave}>
              Save
            </button>
            <button className="titlebar-btn" onClick={onNew} title="New Transcription">
              New
            </button>
          </>
        )}

        <button className="titlebar-btn" title="Open Project (Ctrl+O)" onClick={onOpen}>
          Open
        </button>

        {/* Settings gear */}
        <button className="icon-btn app-no-drag ml-0.5" title="Settings" onClick={onSettingsToggle}>
