...
/** One-click platform aspect chips — quick paths into RESOLUTION_PRESETS values. */
const QUICK_RESOLUTIONS: Array<{ value: [number, number]; label: string }> = [
  { value: [1080, 1920], label: '9:16 1080×1920' },
  { value: [1080, 1350], label: '4:5 1080×1350' },
    ...
    <StudioCard title="Custom Render" defaultOpen={false}>
        ...
        <Select
          ...
          onChange={(e) => {
            ...
            onChange({
              ...
              resolutionIsSource: nextIsSource,
            })
          }}
        >
      ...
      <div className="flex items-center gap-1.5 min-w-0">
        ...
        <div className="flex flex-1 min-w-0 gap-1">
          {QUICK_RESOLUTIONS.map(({ value: [w, h], label }) => {
            const active = s.resolution[0] === w && s.resolution[1] === h
            return (
              <button
                key={label}
                type="button"
